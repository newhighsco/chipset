  ...
  children: (
    <>
      ...
      <p>
        ...
        Sed molestie augue sit amet leo consequat posuere. Vestibulum ante ipsum
...
withInlineStyleOverrides.args = {
  children: (
    <p style={inlineStyles}>
      ...
      into WYSIWYG editors, but is wrapped in a Prose component. It should look
      like regular prose text.
    </p>
  )
}
